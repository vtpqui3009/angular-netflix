...
export const LIMIT_PAGE_TMDB_ALLOW = 100;
...
export const IVY_MOVIE_URL = {
  ...
  TRENDING_MOVIE_WITHIN_WEEK_URL: `${TMDB_URL}/trending/movie/week?api_key=${TMDB_API_KEY}&language=en-US`,
  TRENDING_TV_SERIES_WITHIN_DAY_URL: `${TMDB_URL}/trending/day/day?api_key=${TMDB_API_KEY}&language=en-US`,
  TRENDING_TV_SERIES_WITHIN_WEEK_URL: `${TMDB_URL}/trending/tv/week?api_key=${TMDB_API_KEY}&language=en-US`,
};
